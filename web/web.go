...
type Server struct {
	...
	blockchain *controller.BlockchainController
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	s.blockchain = controller.NewBlockchainController()
	
	// 添加区块链认证路由
	blockchainGroup := g.Group("/blockchain")
	{
		blockchainGroup.POST("/auth/ton", s.blockchain.TonLogin)
		blockchainGroup.POST("/auth/sui", s.blockchain.SuiLogin)
		blockchainGroup.POST("/auth/okx", s.blockchain.OkxLogin)
		blockchainGroup.POST("/auth/verify", s.blockchain.VerifySession)
		blockchainGroup.POST("/auth/logout", s.blockchain.Logout)
	}
